...
// 	at repl.MdocSession$App.displayTemperature(12_Hello_Failures.md:25)
// 	at repl.MdocSession$App.currentTemperatureUnsafe(12_Hello_Failures.md:35)
// 	at repl.MdocSession$App.$init$$$anonfun$1(12_Hello_Failures.md:46)
```
...
// 	at repl.MdocSession$.App.<local App>.getTemperatureZ.macro(12_Hello_Failures.md:148)
```
